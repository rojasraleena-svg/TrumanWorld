# TrumanWorld 前端 Godot 2D 场景接入方案
...
> 当前 TrumanWorld 项目，是否值得把世界页从 SVG/DOM 地图升级为基于 Godot Web 的 2D 场景，以及应当如何接入。
...
> Godot 应该是 TrumanWorld 世界页的 2D 渲染子系统，而不是前端主框架。
...
虽然 Godot 能力很强，但 TrumanWorld 当前的核心仍是：
...
最终目标不应是“把 TrumanWorld 做成游戏”，而应是：

> 把 TrumanWorld 做成一个用户愿意停下来观看、并能直接看懂社会互动正在发生的活世界。
