# Narrative World 前端 Godot 2D 场景接入方案
...
> 当前 Narrative World 项目，是否值得把世界页从 SVG/DOM 地图升级为基于 Godot Web 的 2D 场景，以及应当如何接入。
...
> Godot 应该是 Narrative World 世界页的 2D 渲染子系统，而不是前端主框架。
...
接入 Godot 后，Narrative World 会更像一个：
...
虽然 Godot 能力很强，但 Narrative World 当前的核心仍是：
